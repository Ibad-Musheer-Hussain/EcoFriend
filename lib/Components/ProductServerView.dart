...
class ProductServerView extends StatelessWidget {
  final Map<String, dynamic> product;
  final List<String> targetIngredients;
  final ScrollController scrollController;

  const ProductServerView({
    Key? key,
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("Category:",
                    style:
                        TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                Text(product['categories'] ?? 'No categories',
                    style: const TextStyle(fontSize: 20)),
                const SizedBox(height: 16),
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        showPackagingDialog(
                            context, getPackagingTextList(product));
                      },
                ...
                Row(
                  ...
                  children: [
                    Text(
                      product['ecoscore_data']?.toUpperCase() ??
                          'Not Available',
                      style: const TextStyle(fontSize: 20),
                    ),
                    IconButton(
